...
public_enemies = media.Movie("Inimigos Públicos",
...
the_lighthouse = media.Movie("O Farol",
...
gladiator = media.Movie("Gladiador",
...
moana = media.Movie("Moana: Um Mar de Aventuras",
                    '''Na Polinésia Antiga, quando uma terrível maldição incorrida pelo Semideus Maui chega à ilha de 
                    Moana, ela responde ao chamado do oceano para procurar o Semideus para consertar as coisas.''',
                    "https://i.ytimg.com/vi_webp/85WM7lBEc6o/movieposter.webp",
                    "https://www.youtube.com/watch?v=85WM7lBEc6o")

the_irishman = media.Movie("O Irlandês",
                           '''Um velho lembra-se de seu tempo pintando casas para seu amigo Jimmy Hoffa nos anos 
                           50-70.''',
                           "https://br.web.img3.acsta.net/pictures/19/09/17/11/32/2399182.jpg",
                           "https://www.youtube.com/watch?v=L78AvuU1FLg")

the_silence_of_the_lambs = media.Movie("O Silêncio dos Inocentes",
                                       '''Um jovem cadete do FBI deve receber a ajuda de um assassino canibal 
                                       encarcerado e manipulador para ajudar a capturar outro assassino em série, 
                                       um louco que cuida de suas vítimas.''',
...
fight_club = media.Movie("Clube da Luta",
                         '''Um trabalhador de escritório insone e uma saboneteira do diabo podem cuidar de um clube 
                         de luta subterrâneo que evolui para algo muito, muito maior.''',
                         "https://i.ytimg.com/vi_webp/GGgmCKpc5KA/movieposter.webp",
                         "https://www.youtube.com/watch?v=GGgmCKpc5KA")

scott_pilgrim_vs_the_world = media.Movie("Scott Pilgrim Contra o Mundo",
                                         '''Scott Pilgrim deve derrotar os sete ex-namorados de sua nova namorada 
                                         para conquistar seu coração.''',
                                         "https://i.ytimg.com/vi_webp/TxPF0QVxJ2o/movieposter.webp",
...
se7en = media.Movie("Seven: Os Sete Crimes Capitais",
...
movies = [public_enemies, the_lighthouse, gladiator, moana, the_irishman, the_silence_of_the_lambs, fight_club,
          scott_pilgrim_vs_the_world, scarface, se7en]
